...
const Navigation = () => {
  ...
  return (
  //   <div
  //  className="fixed  bottom-1 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
  // z-50 bg-[#0f0f0f] border w-[50%] px-[2rem] py-[1rem] rounded "
  //   >
  ...
  //         <button
  //           className="text-gray-800 focus:outline-none order-2"
  ...
  //           <ul className={`absolute right-1 mt-2 mr-5 w-[10rem] space-y-2  bg-white text-gray-600 ${!userInfo.isAdmin ? "-top-20" :"-top-24"}`}
  //           >
  //             {userInfo.isAdmin && (
  //               <>
  //               <li>
  ...
  //     </section>
  //   </div>
  <div className="fixed bottom-1 left-1/2 transform -translate-x-1/2 z-50 bg-[#0f0f0f] border w-[50%] px-[2rem] py-[1rem] rounded">
  <section className="flex justify-between items-center">
